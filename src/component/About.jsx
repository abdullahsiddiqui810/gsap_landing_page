      ...
      <div className="mb-16 md:px-0 px-5">
        <div className="content">
          ...
          <div className="sub-content">
            <p>
              At Cocktails, we believe that every drink has a story to tell. Our
              curated selection of cocktails and mocktails is crafted to delight
              your senses and ignite your imagination. Whether you're seeking
              the timeless allure of classic cocktails or the refreshing charm
              of modern mocktails,
            </p>
            <div>
